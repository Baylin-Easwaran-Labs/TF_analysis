...
save(top.tx.hyper, top.tx.hypo,
     file = paste0(wdir, "/cimp_ana/", cre.type, "_topTFs.Rda"))

####################### Comments on FDR cutoff  #########################################

# While identifying top TFs for CIMP specific analysis, FDR cutoff for esophagus cancer 
# was set to 0.20 due to low number of tumor samples in the CIMP-specific categories.
# For all other cancers, FDR cutoff was set to 0.05
